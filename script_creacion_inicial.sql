...
VALUES ((SELECT ID_Persona FROM ANOTHER_CAT.tl_Persona WHERE Nombre = 'ADMINISTRATIVO 1'), 'SEBASTIAN', HASHBYTES('SHA2_256', 'w23e'));
...
INSERT INTO ANOTHER_CAT.tl_Usuario (ID_Persona, Username, Password)
VALUES (0, 'ADMIN' , HASHBYTES('SHA2_256', 'w23e'));
...
INSERT INTO ANOTHER_CAT.tl_Usuario (ID_Persona, Username, Password)
SELECT ID_Afiliado, 'AFILIADO', HASHBYTES('SHA2_256', 'w23e')
...
INSERT INTO ANOTHER_CAT.tl_Usuario (ID_Persona, Username, Password)
SELECT ID_Profesional, 'PROFESIONAL', HASHBYTES('SHA2_256', 'w23e')
